...
public class TransactionEntity<T extends PaymentEntity, T2 extends PaymentEntity> implements Entity {
    ...
    private Date date;
    private String senderCurrencyLabel;
    private String receiverCurrencyLabel;
    ...
    public List<Parameters> getParametersByParametersId(List<ParametersId> parametersIds) {
        ...
        parameters.get(4).setValue(this.senderCurrencyLabel);
        parameters.get(5).setValue(this.receiverCurrencyLabel);
        return parameters;
    }
    ...
    public String getSenderCurrencyLabel() {
        return senderCurrencyLabel;
    }

    public void setSenderCurrencyLabel(String senderCurrencyLabel) {
        this.senderCurrencyLabel = senderCurrencyLabel;
    }

    public String getReceiverCurrencyLabel() {
        return receiverCurrencyLabel;
    }

    public void setReceiverCurrencyLabel(String receiverCurrencyLabel) {
        this.receiverCurrencyLabel = receiverCurrencyLabel;
    }
    ...
    public String toString() {
        return "TransactionEntity{" +
                ...
                ", money=" + money +
                ", senderCurrencyValue=" + senderCurrencyValue +
                ", receiverCurrencyValue=" + receiverCurrencyValue +
                ", date=" + date +
                ", senderCurrencyLabel='" + senderCurrencyLabel + '\'' +
                ", receiverCurrencyLabel='" + receiverCurrencyLabel + '\'' +
                '}';
    }
}