...
public class PurseServices extends BasicDAO {
    ...
    protected List<TransactionEntity> getLastTransactions(Long id) throws DbException {
    ...
    protected List<List<String>> getListOfPursesByUserId(Long userId) {
        return getPursesInfoListByUserId(userId);
    }
